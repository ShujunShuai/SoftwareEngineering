...
public class FindpasswordServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 request.setCharacterEncoding("utf-8");
	        ...
	        //查找用户密码
	        User User=(User)userDao.findPassword(u_mail, u_question);
	        if(User!=null){
	        	//向用户的邮箱发送密码
	    		...
	    		try {
	    			//设置收件人邮箱
	    			email.addTo(User.getU_mail(),User.getU_account());
	    			//发件人邮箱
	    			...
	    			//邮件正文消息
	    			email.setMsg("亲爱的"+User.getU_account()+"您好！感谢您注册Codecore微博系统。你的密码是："+User.getU_password()+"请您妥善保管，以防被他人窃取···");
	    			email.send();
